...
namespace microsoft_azure { namespace storage {
    ...
    public:
        ...
        virtual void download_blob_to_file(const std::string &container, const std::string &blob, const std::string &destPath, const uint64_t file_offset, const uint64_t size, size_t parallel = 9) = 0;
    ...
    public:
        ...
        void download_blob_to_file(const std::string &container, const std::string &blob, const std::string &destPath, const uint64_t file_offset, const uint64_t size, size_t parallel = 9);
